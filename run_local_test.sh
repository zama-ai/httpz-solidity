...
PRIVATE_KEY=$(docker compose -f ../zbc-development/docker-compose.local.yml exec validator evmosd --home /root/.evmosd keys unsafe-export-eth-key $key --keyring-backend test)
